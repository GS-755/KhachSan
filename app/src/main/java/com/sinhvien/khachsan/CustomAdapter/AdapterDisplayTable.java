package com.sinhvien.khachsan.CustomAdapter;
...
import com.sinhvien.khachsan.Activities.PaymentActivity;
import com.sinhvien.khachsan.DAO.BanAnDAO;
import com.sinhvien.khachsan.DAO.DonDatDAO;
import com.sinhvien.khachsan.DTO.BanAnDTO;
import com.sinhvien.khachsan.DTO.DonDatDTO;
import com.sinhvien.khachsan.Fragments.DisplayCategoryFragment;
...
public class AdapterDisplayTable extends BaseAdapter implements View.OnClickListener{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(kttinhtrang.equals("true")){
            viewHolder.imgBanAn.setImageResource(R.drawable.ic_baseline_hotel_24);
        }else {
            viewHolder.imgBanAn.setImageResource(R.drawable.ic_baseline_hotel_24);
        }
